<script lang="ts">
	...
	const textareaClass =
		'w-full rounded-lg border border-gray-100/50 bg-gray-50/40 px-2.5 py-2 text-xs text-gray-700 outline-hidden transition-colors disabled:opacity-50 dark:border-white/[0.04] dark:bg-white/[0.03] dark:text-gray-300';
