								...
								<div class="p-1 flex-1 flex gap-2">
									<div class=" flex-1">
										...
										<input
											...
											type="number"
											class="h-7 w-full rounded-lg border border-gray-100/50 bg-gray-50/40 px-2 text-center text-xs text-gray-700 outline-hidden transition-colors placeholder:text-gray-300 dark:border-white/[0.04] dark:bg-white/[0.03] dark:text-gray-300 dark:placeholder:text-gray-700"
											min="0"
